export const t = {
  ...
  contact: {
    ...
    brunchAlt: {
      k: 'UI/UX 디자이너 김경환의 브런치 링크',
      e:
        'Brunch, the Korean version of Medium, Link of UI/UX designer KyungHwan Kim',
    },

    about: {
      // [인생 목표, 경력, 개인 프로젝트, 전시, 강연] 순으로 각각 [카테고리, 날짜, 내용] 배열
      lifeGoal: {
        title: {
          k: '인생 목표',
          e: 'Life Goal',
      ...
      career: {
        ...
        contentsArray: [
          ...
          {
            term: {
              k: '2015.10.01 ~ 2018.09.28',
              e: '2015.10.01 ~ 2018.09.28',
            },
            contents: {
              k: '동아사이언스 과학 기자',
              e: 'DongaScience Science Journalist',
            },
          },
        ],
      },
  ...
  shareDesignProjectIntroduction: {
    goToIntroduction: {
      k: '디자인 공유하기 프로젝트 >',
