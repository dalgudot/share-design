  ...
  return {
    ...
    contents: [
...

      {
        ...
        e:
          '\u00A0\u00A0\u00A0However, it was impossible to implement all of my thoughts in platform where the content format such as text or video is fixed, such as Brunch, YouTube and Medium, and the language cannot be changed within content. In order to share the UI/UX design experience with people around the world, I had to build a platform for creating and distributing content. This led to the thought of sharing the UI/UX design experience with my web portfolio.',
      },
      ...
      {
        k:
          "\u00A0\u00A0\u00A0그렇게 내 웹 포트폴리오로 UI/UX 디자인 경험을 공유하자는 '디자인 공유하기(SHARE DESIGN) 프로젝트'를 2020년 9월 12일에 시작했다. 주말이라는 제한된 시간 속에서 기획부터 디자인, 웹 개발, 앱 개발, 콘텐츠 제작, 번역까지 모든 일을 혼자 진행하느라 첫 번째 콘텐츠를 배포하기까지 시간이 꽤 오래 걸렸다. 그 시간을 지나 2021년 3월 28일 첫 콘텐츠를 배포했다.",
        e:
