  ...
  return {
    ...
    references: [
      {
        ...
        content: {
          k: "UI/UX 디자인은 '선택'의 연속이다. UI/UX 디자이너는 여러 디자인 시안을 고민해보고 사용자에게 가장 좋은 경험을 주는...",
          e: "UI/UX 디자인은 '선택'의 연속이다. UI/UX 디자이너는 여러 디자인 시안을 고민해보고 사용자에게 가장 좋은 경험을 주는...",
        },
      },
      {
      ...
      },
      {
        ...
        content: {
          k: 'WebGradients is a free collection of 180 linear gradients that you can use as content backdrops...',
          e: 'WebGradients is a free collection of 180 linear gradients that you can use as content backdrops...',
        },
      },
      {
        url: 'http://uidesignguides.com/%EB%94%94%EC%9E%90%EC%9D%B8-%EC%8B%9C%EC%8A%A4%ED%85%9C%EC%97%90-%EB%AA%A8%EC%85%98%EC%9D%84-%EC%A0%81%EC%9A%A9%ED%95%98%EB%8A%94-5%EB%8B%A8%EA%B3%84/',
        title: {
          k: '디자인 시스템에 모션을 적용하는 5단계',
          e: '디자인 시스템에 모션을 적용하는 5단계',
        },
        content: {
          k: 'UI에서 모션은 멋있어 보이는 효과 말고도 다음과 같은 방식으로 사용자 경험에 도움이...',
          e: 'UI에서 모션은 멋있어 보이는 효과 말고도 다음과 같은 방식으로 사용자 경험에 도움이...',
        },
      },
      {
        ...
        content: {
          k: "이 글은 '디자이너들이 모션의 사용성을 확인할 때 어떤 것을 고려해야 할까'라는 질문에 대한 답이 될 수 있...",
          e: "이 글은 '디자이너들이 모션의 사용성을 확인할 때 어떤 것을 고려해야 할까'라는 질문에 대한 답이 될 수 있...",
        },
      },
      {
        ...
        content: {
          k: '최근 들어 뜨고 있는 UI 기법 중 하나로 UI 요소들에 모션을 적용해 전체적인 디자인을 더 풍성하게 만들고...',
          e: '최근 들어 뜨고 있는 UI 기법 중 하나로 UI 요소들에 모션을 적용해 전체적인 디자인을 더 풍성하게 만들고...',
        },
      },
      {
        ...
        content: {
          k: '플랫한 UI들이 자리잡은지 오래이고 이제는 더욱 심플하기 위해 라인 UI들이 대세를 이룰 정도로 많이 보입니...',
          e: '플랫한 UI들이 자리잡은지 오래이고 이제는 더욱 심플하기 위해 라인 UI들이 대세를 이룰 정도로 많이 보입니...',
        },
      },
    ],
    ...
    contents: [
...

      {
        ...
        caption: '',
        alt: {
          k: "아티클 '모션 디자인은 UX에 어떤 영향을 미칠까?'의 대표 이미지",
          e: "Main image of the article 'How does motion design affect UX?'",
        },
      },
...

      {
        ...
        content: {
          ...
          e: "\u00A0\u00A0\u00A0In fact, this motion is the realization of 'circulating' and 'quick' among the three keywords of Koodon's brand keyword,'circulating, helpful, and quick'. It is a meaningful motion with a brand. However, it is still questionable whether this motion is meaningful to the user or gives a good UX.",
        },
      },
...

      {
        key: 'PLarge',
        content: {
          k: '\u00A0\u00A0\u00A0물론 요즘에는 디지털 프로덕트 UI 디자인에서 모션이 있는 게 일반적이라, 모션이 없는 프로덕트를 보면 생동감이 없는 딱딱한 느낌을 받는 것도 사실입니다. 디자이너의 시각에서 모션이 화려한 프로덕트를 보면 정말 멋지고 저도 만들어보고 싶다고 느끼지만, 과연 사용자에게는 어떤 영향을 미칠까요?',
          e: "\u00A0\u00A0\u00A0Of course, these days, it is common for digital product UI design to have motion, so it is true that when you look at a product without motion, you get a hard feeling without a sense of life. From a designer's perspective, looking at a product with colorful motion is really cool and I feel like I want to make it, but will users feel that way?",
        },
      },
