export const uiUxDesign1 = () => {
  return {
    ...
    summary: {
      k:
        '디자인 공유하기는 전 세계 사람들에게 UI/UX 디자인 경험을 공유하기 위한 디지털 프로덕트(Digital Product)다. 내가 글을 쓸 수 있는 한국어와 영어 두 언어로 콘텐츠를 제공...',
      e:
        'SHARE DESIGN is a digital product to share UI/UX design experience with people around the world. Contents are provided in both Korean and English...',
    },
